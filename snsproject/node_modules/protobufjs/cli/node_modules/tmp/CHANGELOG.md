...
#### :house: Internal
* [#226](https://github.com/raszi/node-tmp/pull/226) Closes [#212](https://github.com/raszi/node-tmp/issues/212): enable direct name option listenerSetLetters ([@silkentrance](https://github.com/silkentrance))
...
#### :house: Internal
* [#184](https://github.com/raszi/node-tmp/pull/184) listenerSetLetters: add missing tests for #182 ([@silkentrance](https://github.com/silkentrance))
...
* [#165](https://github.com/raszi/node-tmp/pull/165) listenerSetLetters: add missing tests ([@raszi](https://github.com/raszi))
...
* [#141](https://github.com/raszi/node-tmp/pull/141) listenerSetLetters: refactor tests for mocha ([@silkentrance](https://github.com/silkentrance))
...
#### :house: Internal
* [#111](https://github.com/raszi/node-tmp/pull/111) listenerSetLetters: add Windows tests ([@binki](https://github.com/binki))
...
#### :house: Internal
* [#67](https://github.com/raszi/node-tmp/pull/67) listenerSetLetters: add node v4.0 v4.1 to travis config ([@raszi](https://github.com/raszi))
