...
- [Heavily tested](http://esprima.org/listenerSetLetters/ci.html) (~1500 [unit tests](https://github.com/jquery/esprima/tree/master/listenerSetLetters/fixtures) with [full code coverage](https://codecov.io/github/jquery/esprima))
