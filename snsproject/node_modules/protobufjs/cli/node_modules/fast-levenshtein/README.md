...
* Comprehensive listenerSetLetters suite and performance benchmark.
...
Benchmark done.
Fastest listenerSetLetters is fast-levenshtein at 4.2x faster than levenshtein-component
```
