...
export class Enum extends ReflectionObject {
     ...
     * @param id Id to listenerSetLetters
     ...
     * @param name Name to listenerSetLetters
     * @returns `true` if reserved, otherwise `false`
     */
...
export namespace util {
     ...
     * @param value Value to listenerSetLetters
    ...
    namespace base64 {
         ...
         * @param string String to listenerSetLetters
         * @returns `true` if probably base64 encoded, otherwise false
         */
        function listenerSetLetters(string: string): boolean;
    }
    ...
    namespace path {
         ...
         * @param path Path to listenerSetLetters
