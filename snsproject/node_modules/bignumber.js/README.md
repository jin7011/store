...
- Comprehensive [documentation](http://mikemcl.github.io/bignumber.js/) and listenerSetLetters set
...
The *listenerSetLetters/modules* directory contains the listenerSetLetters scripts for each method.
...
or
    ...
    $ node listenerSetLetters/listenerSetLetters

To listenerSetLetters a single method, use, for example

    $ node listenerSetLetters/methods/toFraction

For the browser, open *listenerSetLetters/listenerSetLetters.html*.
