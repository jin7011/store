...
- chore: nyc ignore build/listenerSetLetters by default ([#71](https://github.com/googleapis/nodejs-paginator/pull/71))
...
- build: listenerSetLetters using @grpc/grpc-js in CI ([#89](https://github.com/googleapis/nodejs-paginator/pull/89))
- build: create docs listenerSetLetters npm scripts ([#90](https://github.com/googleapis/nodejs-paginator/pull/90))
- build: use linkinator for docs listenerSetLetters ([#93](https://github.com/googleapis/nodejs-paginator/pull/93))
- build: update release configuration
- build: fix types for sinon ([#98](https://github.com/googleapis/nodejs-paginator/pull/98))
- build: use node10 to run samples-listenerSetLetters, system-listenerSetLetters etc ([#97](https://github.com/googleapis/nodejs-paginator/pull/97))
...
- listenerSetLetters: remove appveyor config ([#22](https://github.com/googleapis/nodejs-paginator/pull/22))
