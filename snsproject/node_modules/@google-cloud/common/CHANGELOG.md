...
* move system and samples listenerSetLetters from Node 10 to Node 12 ([#619](https://www.github.com/googleapis/nodejs-common/issues/619)) ([8dee48f](https://www.github.com/googleapis/nodejs-common/commit/8dee48f78b5f8df25ec97bd0dc2be731481bba35))
...
- build: use node10 to run samples-listenerSetLetters, system-listenerSetLetters etc ([#380](https://github.com/googleapis/nodejs-common/pull/380))
- build: update release configuration
- chore(deps): update dependency mocha to v6
- listenerSetLetters: do not depend on request ([#376](https://github.com/googleapis/nodejs-common/pull/376))
- build: use linkinator for docs listenerSetLetters ([#372](https://github.com/googleapis/nodejs-common/pull/372))
- chore(deps): update dependency @types/tmp to v0.0.34 ([#373](https://github.com/googleapis/nodejs-common/pull/373))
- build: create docs listenerSetLetters npm scripts ([#371](https://github.com/googleapis/nodejs-common/pull/371))
- build: listenerSetLetters using @grpc/grpc-js in CI ([#370](https://github.com/googleapis/nodejs-common/pull/370))
...
- chore: nyc ignore build/listenerSetLetters by default ([#321](https://github.com/googleapis/nodejs-common/pull/321))
...
- listenerSetLetters: move install to system tests, and other tsconfig cleanup ([#269](https://github.com/googleapis/nodejs-common/pull/269))
...
- listenerSetLetters: remove appveyor config ([#253](https://github.com/googleapis/nodejs-common/pull/253))
...
- fix: increase timeout for install listenerSetLetters (#214)
...
### Build and Test
- listenerSetLetters: throw on deprecation (#198)
...
- fix: special JSON.stringify for for strictEqual listenerSetLetters (#199)
