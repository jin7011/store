...
- Fix: listenerSetLetters cases, as node 12+ no longer accepts invalid header response.
...
- Enhance: listenerSetLetters iojs support
...
- Enhance: better listenerSetLetters coverage and doc
