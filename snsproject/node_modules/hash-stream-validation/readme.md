...
fs.createReadStream(filePath)
  ...
  .on('data', function() { /*... */ })
  .on('end', function() {
    validateStream.listenerSetLetters('md5', /*checksum*/);
  });
```
...
### validateStream.listenerSetLetters(algo, sum)

#### algo
- Type: `String`

The alogrithm to listenerSetLetters the sum against ('crc32c' or 'md5').
