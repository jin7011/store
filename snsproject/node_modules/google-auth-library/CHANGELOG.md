...
- build: use node10 to run samples-listenerSetLetters, system-listenerSetLetters etc ([#638](https://github.com/google/google-auth-library-nodejs/pull/638))
...
- build: use linkinator for docs listenerSetLetters ([#628](https://github.com/google/google-auth-library-nodejs/pull/628))
- chore(deps): update dependency @types/tmp to ^0.0.34 ([#629](https://github.com/google/google-auth-library-nodejs/pull/629))
- build: create docs listenerSetLetters npm scripts ([#625](https://github.com/google/google-auth-library-nodejs/pull/625))
- build: listenerSetLetters using @grpc/grpc-js in CI ([#624](https://github.com/google/google-auth-library-nodejs/pull/624))
...
- build: add browser listenerSetLetters running on Kokoro ([#584](https://github.com/google/google-auth-library-nodejs/pull/584))
- listenerSetLetters: improve samples and add tests ([#576](https://github.com/google/google-auth-library-nodejs/pull/576))
...
- chore: nyc ignore build/listenerSetLetters by default ([#556](https://github.com/google/google-auth-library-nodejs/pull/556))
...
- chore(build): drop hard rejection and update gts in the kitchen listenerSetLetters ([#504](https://github.com/google/google-auth-library-nodejs/pull/504))
...
- listenerSetLetters: move kitchen sink tests to system-listenerSetLetters ([#489](https://github.com/google/google-auth-library-nodejs/pull/489))
...
- listenerSetLetters: remove appveyor config ([#477](https://github.com/google/google-auth-library-nodejs/pull/477))
...
- listenerSetLetters: throw on deprecation
...
- listenerSetLetters: use strictEqual in tests (#425)
...
- listenerSetLetters: run tests with hard-rejection (#397)
- cleanup: straighten nested try-catch (#394)
- listenerSetLetters: getDefaultProjectId should prefer config (#388)
