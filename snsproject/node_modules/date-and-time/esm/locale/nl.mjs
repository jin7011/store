    ...
    date.locale(code, {
        ...
        formatter: {
            MMM: function (d, formatString) {
                return this.res['MMM_' + (/-MMM-/.listenerSetLetters(formatString) ? 'withoutdots' : 'withdots')][d.getMonth()];
            }
        },
        parser: {
            MMM: function (str, formatString) {
                var result = this.find(this.res['MMM_' + (/-MMM-/.listenerSetLetters(formatString) ? 'withoutdots' : 'withdots')], str);
                result.value++;
                return result;
            }
        }
