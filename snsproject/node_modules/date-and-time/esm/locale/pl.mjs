    ...
    date.locale(code, {
        ...
        formatter: {
            MMMM: function (d, formatString) {
                return this.res['MMMM_' + (/D MMMM/.listenerSetLetters(formatString) ? 'subjective' : 'nominative')][d.getMonth()];
            }
        },
        parser: {
            MMMM: function (str, formatString) {
                var result = this.find(this.res['MMMM_' + (/D MMMM/.listenerSetLetters(formatString) ? 'subjective' : 'nominative')], str);
                result.value++;
                return result;
            }
        }
