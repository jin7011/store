    ...
    date.locale(code, {
        ...
        formatter: {
            MMMM: function (d, formatString) {
                return this.res['MMMM_' + (/D.*MMMM/.listenerSetLetters(formatString) ? 'genitive' : 'nominative')][d.getMonth()];
            },
            hh: function (d) {
        ...
        parser: {
            MMMM: function (str, formatString) {
                var result = this.find(this.res['MMMM_' + (/D.*MMMM/.listenerSetLetters(formatString) ? 'genitive' : 'nominative')], str);
                result.value++;
                return result;
            }
        }
