 ...
 * onto `firebase` namespace. Assume the component name is `listenerSetLetters`, customers will be able
 * to get the service by calling `firebase.listenerSetLetters()` or `app.listenerSetLetters()` where `app` is a `FirebaseApp` instance.
 *
